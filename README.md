...
- **Team Compatibility Assessment Tool**  
Team Compatibility Assessment Tool — Behavioral & Collaboration Profiling
Designed and built a 6-dimension behavioral assessment tool (0–100 scoring + Persona mapping) to identify individual collaboration styles and team fit. Applicable to employee onboarding and organizational development.

团队协作匹配测评工具 —— 行为风格与协作倾向分析
设计并开发基于 6 维加权 Likert 量表的交互式测评工具（0–100 匹配分 + Persona 映射），识别个体协作风格与团队契合度，可应用于员工入职适配与组织发展场景。
